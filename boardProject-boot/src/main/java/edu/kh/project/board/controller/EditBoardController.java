...
public class EditBoardController {
	 ...
	 */
	// [0-9]+ : 모든 숫자 범위
	// boardCode:[0-9]+ : boardCode가 모든 숫자 범위일 때
	 ...
	 * @param ra : 리다이렉트 시 request scope로 데이터 전달할 수 있게 해줌
	 * @return
	 * @throws IOException 
	...
	public String boardInsert (
			...
			@RequestParam("images") List<MultipartFile> images, // 이미지 하나도 안올려도 images는 5칸이 만들어짐 리스트는 있는 것... 실제 있는지 없는지는 Service딴에서 따져야함
